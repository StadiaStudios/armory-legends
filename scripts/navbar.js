        ...
        <div class="text-right">
            ...
            <div class="text-[9px] md:text-xs text-zinc-400 uppercase tracking-widest">
                ...
                <div id="mobile-dropdown" class="absolute top-full left-0 w-full bg-zinc-900 border border-zinc-800 z-[100] hidden flex-col p-4 space-y-4 shadow-2xl">
                    ...
                    <a href="../"><button class="text-left text-sm font-bold uppercase tracking-widest hover:text-amber-500 py-2 border-b border-zinc-800">Currency Shop</button></a>
            ...
            <nav id="desktop-nav" class="hidden md:flex space-x-8 mb-8 text-sm font-bold uppercase tracking-widest border-b border-zinc-800">
                ...
                <a href="../"><button onmouseenter="playHover()" class="pb-2 text-zinc-500 hover:text-amber-500">Store</button></a>
